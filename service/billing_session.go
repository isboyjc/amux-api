	...
	case *WalletFunding:
		...
		if userQuota < delta {
			return types.NewErrorWithStatusCode(
				fmt.Errorf("预扣费额度失败, 用户剩余额度: %s, 需要补充预扣费额度: %s", logger.FormatQuota(userQuota), logger.FormatQuota(delta)),
		...
		s.relayInfo.UserQuota = userQuota - delta
