...
func migrateDB() error {
	...
	// 一次性迁移：把存量用户的 record_ip_log 翻到 true。这个开关之前默认
	// 关闭，导致线上大部分用户没记 IP，故障定位时拿不到来源。详见
	// BackfillUserRecordIpLog 注释。
	BackfillUserRecordIpLog()
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Checkin{}, "Checkin"},
		{&BlindBoxDraw{}, "BlindBoxDraw"},
		{&BlindBoxWinner{}, "BlindBoxWinner"},
		{&BlindBoxEntry{}, "BlindBoxEntry"},
		{&BlindBoxBlock{}, "BlindBoxBlock"},
		...
		{&AffiliateRiskCache{}, "AffiliateRiskCache"},
		{&AffiliateRiskDirty{}, "AffiliateRiskDirty"},
