...
const Dashboard = () => {
  ...
  const dashboardCharts = useDashboardCharts(
    ...
    dashboardData.setPromptTokens,
    dashboardData.setCompletionTokens,
    dashboardData.setCacheReadTokens,
    dashboardData.setCacheWriteTokens,
  ...
  const { groupedStatsData } = useDashboardStats(
    ...
    dashboardData.promptTokens,
    dashboardData.completionTokens,
    dashboardData.cacheReadTokens,
    dashboardData.cacheWriteTokens,
    dashboardData.times,
