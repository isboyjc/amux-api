...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/public/token_stats", controller.GetPublicTokenStats)
		...
		apiRouter.GET("/pricing/health", middleware.TryUserAuth(), controller.GetModelHealth)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff_rebate_stats", controller.GetAffRebateStats)
				selfRoute.GET("/invitees", controller.GetInvitees)
				selfRoute.GET("/invitee/:invitee_id/topups", controller.GetInviteeTopups)
				selfRoute.GET("/topup/info", controller.GetTopUpInfo)
				selfRoute.GET("/topup/self", controller.GetUserTopUps)
				selfRoute.GET("/topup/:trade_no/invoice", controller.GetTopUpInvoice)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/modality-meta", controller.GetModelModalityMeta)
