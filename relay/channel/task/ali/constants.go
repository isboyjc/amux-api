...
var ModelList = []string{
	...
	"happyhorse-1.1-i2v",        // HappyHorse 1.1 首帧图生视频
	"happyhorse-1.0-i2v",        // HappyHorse 1.0 首帧图生视频
	"happyhorse-1.1-r2v",        // HappyHorse 1.1 多参考图生视频
	"happyhorse-1.0-r2v",        // HappyHorse 1.0 多参考图生视频
	"happyhorse-1.0-video-edit", // HappyHorse 1.0 视频编辑
	"wan2.7-i2v-2026-04-25",     // 万相 2.7 新版图生视频（首帧/首尾帧/续写/音频）
